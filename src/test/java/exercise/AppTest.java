...
class AppTest {
    ...
    void testCharAt() {
        ...
        assertThat(sequence.charAt(5)).isEqualTo('a');
    }

    @Test
    void testSubSequence() {
        ReversedSequence sequence = new ReversedSequence("abcdef");
        assertThat(sequence.subSequence(1, 3)).isEqualTo("ed");
        assertThat(sequence.subSequence(0, 6)).isEqualTo("fedcba");
    }

    @Test
    void testToString() {
        ReversedSequence sequence = new ReversedSequence("abcdef");
        assertThat(sequence.toString()).isEqualTo("fedcba");
    }
    // END
}
